...
(cl:in-package my_project_msg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterHistory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterHistory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_project_msg-msg:<CounterHistory> is deprecated: use my_project_msg-msg:CounterHistory instead.")))

(cl:ensure-generic-function 'current_value-val :lambda-list '(m))
(cl:defmethod current_value-val ((m <CounterHistory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_project_msg-msg:current_value-val is deprecated.  Use my_project_msg-msg:current_value instead.")
  (current_value m))

(cl:ensure-generic-function 'last_value-val :lambda-list '(m))
(cl:defmethod last_value-val ((m <CounterHistory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_project_msg-msg:last_value-val is deprecated.  Use my_project_msg-msg:last_value instead.")
  (last_value m))

(cl:ensure-generic-function 'cycles-val :lambda-list '(m))
(cl:defmethod cycles-val ((m <CounterHistory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_project_msg-msg:cycles-val is deprecated.  Use my_project_msg-msg:cycles instead.")
  (cycles m))
